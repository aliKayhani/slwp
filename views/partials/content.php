...
<section id="content">
	...
	<div class="content-wrap">
		...
		<div class="promo parallax promo-full bottommargin-lg" style="background-image: url(<?php echo Asset::image('parallax/3.jpg'); ?>" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
			<div class="container clearfix">
		...
		<div class="container clearfix">
			...
			<div class="col_one_third bottommargin-lg">
				<div class="feature-box center media-box fbox-bg">
					<div class="fbox-media">
						<img src="<?php echo Asset::image('shop/banners/7.jpg') ?>" alt="Image">
					</div>
					<div class="fbox-desc">
			...
			<div id="oc-clients-full" class="owl-carousel image-carousel carousel-widget" data-margin="30" data-nav="false" data-autoplay="5000" data-pagi="false" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="7">
				...
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/1.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/2.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/3.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/4.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/5.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/6.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/7.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/8.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/9.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/10.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/11.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/12.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/13.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/14.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/15.jpg') ?>" alt="Clients"></a></div>
				<div class="oc-item"><a href="#"><img src="<?php echo Asset::image('clients/logo/16.jpg') ?>" alt="Clients"></a></div>
